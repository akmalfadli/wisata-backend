            ...
            <div class="section-body">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4><i class="fas fa-money-check-alt"></i> Edit Akun Keuangan</h4>
                    </div>

                    <div class="card-body">

                        <form action="{{ route('account.account.update', $account->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nominal" value="{{ old('nominal', $account->nominal) }}" placeholder="Masukkan Nominal" class="form-control currency">
