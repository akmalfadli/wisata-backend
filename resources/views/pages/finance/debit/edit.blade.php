    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                ...
                <div class="card">
                    <form action="{{ route('finance.debit.update', $debit) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                is-invalid
                            @enderror"
                                    name="description" value="{{$debit->description}}">
                                @error('description')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row g-0">
                                    <div class="col-4"> <!-- Align the input group container to the left -->
                                        <div class="input-group">
                                            <input type="text" id="debit_date" class="form-control datetimepicker" name="credit_date" placeholder="Pilih Tanggal" value="{{$debit->debit_date}}">
