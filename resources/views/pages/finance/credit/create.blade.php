    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                ...
                <div class="card">
                    <form action="{{ route('finance.credit.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select class="form-control select2 @error('account_finance') is-invalid @enderror" name="account_finance" id="account_finance">
                                    <option value="">Belum ada akun yang dipilih</option>
                                    @foreach ($accounts as $account)
                                        <option value="{{$account->id}}" {{ old('account_finance') == $account->id ? 'selected' : '' }}>{{$account->name}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                <label for="credit_date" class="text-start">Tanggal</label>
                                <div class="row g-0">
                                    <div class="col-4">
                                        <div class="input-group">
                                            <input type="text" id="credit_date" class="form-control datetimepicker @error('credit_date') is-invalid @enderror" name="credit_date" placeholder="Pilih Tanggal" value="{{ old('credit_date') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 @error('category_id') is-invalid @enderror" name="category_id" style="width: 100%">
                                            ...
                                            @foreach ($categories as $categori)
                                                <option value="{{$categori->id}}" {{ old('category_id') == $categori->id ? 'selected' : '' }}>{{$categori->name}}</option>
                                            @endforeach
                                        </select>
